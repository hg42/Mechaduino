...
static entry menu[] = {
  ...
  {     0, ""},
  {     do_mode_x,              "x  -  position mode"},
  {     do_mode_v,              "v  -  velocity mode"},
  {     do_mode_t,              "t  -  torque mode"},
  {     do_mode_h,              "h  -  hybrid mode (experimental)"},
  {     0, ""},
