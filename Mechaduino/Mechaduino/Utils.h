...
#define __UTIL_H__
  ...
  void oneStep(int effort = 0);     //take one step
  ...
  void parameterEdit_main();        //parameter editing menu

  void parameterEdit_p();           //parameter editing menu

  void parameterEdit_v();           //parameter editing menu

  void parameterEdit_o();           //parameter editing menu
